...
for i in tqdm(range(traindf.shape[0]-1000000)):
#	try:
	if i % 5 == 0:
		# loading the image and keeping the target size as (224,224,3)
		img = image.load_img("./TrainFrames/"+traindf['FrameID'][i], target_size=(50,50,3))
...
# for loop to read and store frames
for i in tqdm(range(valdf.shape[0]-200000)):
#	try:
	if i % 5 == 0:
	    # loading the image and keeping the target size as (224,224,3)
	    img = image.load_img("./ValidationFrames/"+valdf['FrameID'][i], target_size=(50,50,3))
	    # converting it to array
	    img = image.img_to_array(img)
	    # normalizing the pixel value
	    img = img/255
...
# for loop to read and store frames
for i in tqdm(range(testdf.shape[0]-200000)):
    if i % 5 == 0:
        # loading the image and keeping the target size as (224,224,3)
        img = image.load_img("./TestFrames/"+testdf['FrameID'][i], target_size=(50,50,3))
        # converting it to array
        img = image.img_to_array(img)
        # normalizing the pixel value
        img = img/255
